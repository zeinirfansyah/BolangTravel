      ...
      <div className="max-w-7xl mx-auto">
        <nav className="Navbar md:flex justify-between gap-20 items-center py-6 mx-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-end justify-end gap-2">
              <div className="flex sm:hidden">
                <button
                  className="block h-8 w-8 lg:h-6 lg:w-6 scale-[.80] lg:scale-110 rounded-full overflow-hidden border-2 border-white focus:outline-none order-1"
                  onClick={menuAccount}
                  type="button">
                  <img
                ...
                <div
                  className={`py-2 w-40 bg-white text-sm font-medium rounded-lg absolute top-[5.6rem] right-[4rem] shadow-lg ${
                    isMenuAccount ? "" : "hidden"
                  } `}>
                  <Link
                    to="/"
                    className="block px-4 py-2 text-slate-800 hover:bg-gray-200">
                    Data Booking
                  </Link>
                  <Link
                    to="/"
          ...
          <div className="hidden md:flex">
            ...
            <div
              className={`py-2 w-40 bg-white text-sm font-medium rounded-lg absolute md:top-[5.5rem] md:right-[1rem] shadow-lg ${
                isMenuAccount ? "" : "hidden"
              } `}>
              <Link
                to="/"
